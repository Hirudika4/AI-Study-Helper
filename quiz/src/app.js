...
function RenderQuizCard(props) {
  ...
  }, "style": {"padding": "8px 18px", "borderRadius": "999px", "border": "1px solid #2563eb", "background": "linear-gradient(135deg,#3b82f6,#6366f1)", "color": "#ffffff", "fontWeight": "600", "fontSize": "13px", "cursor": "pointer", "boxShadow": "0 8px 20px rgba(37,99,235,0.45)"}}, ["Submit"])]), __jacJsx("div", {"style": {"marginTop": "6px", "fontSize": "13px", "color": "#0f172a", "minHeight": "18px"}}, [props.quizFeedback])]);
}
function app() {
